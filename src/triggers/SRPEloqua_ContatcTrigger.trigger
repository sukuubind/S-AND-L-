trigger SRPEloqua_ContatcTrigger on Contact (after delete, after insert, after update) {
    ...
    Boolean bypassTrigger = triggerOverride != null && 
        (triggerOverride.Override_All__c || triggerOverride.SRPEloqua_ContactTrigger__c); 
